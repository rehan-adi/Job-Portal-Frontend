...
function JobDetail() {
  ...
  return (
    ...
    <div className='flex justify-between flex-col lg:flex-row lg:items-start items-center'>
      ...
      <h1 className='font-semibold mt-2 text-gray-600'>{job.companyName}</h1>
      ...
      <p className="lg:pr-24 w-[70vw] mt-5 lg:w-auto opacity-80">{job.jobDescription}</p>
      ...
      <div className='mt-5 flex flex-col lg:flex-row gap-1 lg:gap-5'>
         ...
         <p className='lg:mt-2 mt-3'><span><FaLaptopCode  className='inline-block mr-1 mb-1'/> <span className='mr-2 '>Skills: </span> </span><span className='opacity-80'>{job.requiredSkills}</span></p>
      </div>
      ...
      <div className="mt-10 lg:w-[27vw] w-[90vw] bg-white border-2 lg:border p-6 rounded-xl shadow-lg">
        ...
        <form >
            <div className="mb-5">
              ...
              <input type="text" id="name" name="name" className="mt-1 block w-full border focus:outline-none focus:shadow-outline px-2 py-1 rounded-md shadow-sm " placeholder='Enter Full Name' required />
            </div>
            <div className="mb-5">
              <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email Address</label>
              <input type="email" id="email" name="email" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm border focus:outline-none focus:shadow-outline px-2 py-1 " placeholder='Enter Email' required />
            </div>
            <div className="mb-5">
              <label htmlFor="resume" className="block text-sm font-medium text-gray-700">Resume/CV (PDF)</label>
              <input type="file" id="resume" name="resume" accept=".pdf" className="mt-1 block w-full border-gray-300 focus:outline-none focus:shadow-outline rounded-md shadow-sm" required />
            </div>
            <button type="submit" className="inline-block bg-[#F05537] text-white py-1 mt-4 px-4 rounded-md transition duration-300 ">Apply Now</button>
          </form>
      </div>
