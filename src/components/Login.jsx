      ...
      <div className="rounded-lg lg:w-[28vw] md:w-[45vw] sm:w-[45vw] w-full px-5 py-10">
        ...
        <div class="w-full">
          ...
          <div className="flex items-center mt-9 justify-between">
            <button
              class="select-none rounded-lg border w-full lg:w-auto border-[#EA580C] hover:bg-[#EA580C] py-2.5 px-10 text-center align-middle font-sans text-sm font-bold text-white transition-all"
              type="button"
            >
              Sign In
            </button>
